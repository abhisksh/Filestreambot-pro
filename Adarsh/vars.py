...
class Var(object):
    ...
    if 'DYNO' in environ:
        ...
        ON_HEROKU = False
    FQDN = str(getenv('FQDN', '67.219.139.52:8080')) if not ON_HEROKU or getenv('FQDN', '67.219.139.52:8080') else APP_NAME+'.herokuapp.com'
    ...
    UPDATES_CHANNEL = str(getenv('UPDATES_CHANNEL', 'movies_spirit'))
